...
description: Use when generated ML pipeline code reads or writes artifacts JSON; defines expected keys for EDA, model metrics, model comparison, evaluation summary, and reporting compatibility.
---
